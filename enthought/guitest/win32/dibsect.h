...
public:
  ...
  bool ToGrayScale();  
  bool ToClipboard();
  bool CopyClient(HWND hwnd, int left, int top, int right, int bottom);
  bool CopyWindow(HWND hwnd);

#ifndef SWIG // Don't wrap the following.
  HBITMAP CopyWndClient(HWND hWnd,RECT * pr=NULL);
