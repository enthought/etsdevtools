...
TRAITSBACKENDWX = etsdep('TraitsBackendWX', '3.0.0')  # -- imported mostly by enthought.developer, but one from enthought.gotcha
TRAITSGUI = etsdep('TraitsGUI', '3.0.0')
TRAITSGUI_DOCK = etsdep('TraitsGUI[dock]', '3.0.0')  # -- imported only by enthought.developer.
